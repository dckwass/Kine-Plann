...
function downloadPDF(result, problem) {
...
<body>
  ...
  <div style="background:#f0faf5;border:1px solid #c0e8d0;border-radius:10px;padding:16px 20px;margin-bottom:20px;">
    <div style="font-family:monospace;font-size:9px;color:#888;letter-spacing:2px;text-transform:uppercase;margin-bottom:8px;">Patientenbeschreibung</div>
    <div style="font-size:13px;color:#2A3D2F;line-height:1.6;font-style:italic;">${problem}</div>
  </div>
  <div style="background:#f0faf5;border:1px solid #c0e8d0;border-radius:10px;padding:16px 20px;margin-bottom:20px;">
  ...
  ${exerciseRows}
  <div style="margin-top:32px;padding-top:20px;border-top:1px solid #dde8e2;text-align:center;font-family:monospace;font-size:11px;color:#aaa;line-height:1.8;">
        ...
        {status === "done" && result && (
          <div ref={resultsRef}>
            ...
            <div style={{ marginTop: 40, display: "flex", justifyContent: "center" }}>
              <button
                onClick={() => downloadPDF(result, problem)}
                style={{
